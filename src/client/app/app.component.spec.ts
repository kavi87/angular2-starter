      ...
      return [
        ...
        {provide: Location, useClass: SpyLocation},
        {
          ...
          useFactory: (
            ...
            location:Location,
            injector:Injector) => {
            const r = new Router(<any>TestComponent, resolver, urlSerializer, outletMap, location, injector, config);
//            r.initialNavigation();
            return r;
          },
    ...
    it('should build without a problem',
      async(inject([TestComponentBuilder], (tcb:TestComponentBuilder) => {
        tcb.overrideProviders(<any>TestComponent, providerArr)
          .createAsync(<any>TestComponent)
          .then((fixture) => {
